;;; flymake-flycheck-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "flymake-flycheck" '("flymake-flycheck-")))
